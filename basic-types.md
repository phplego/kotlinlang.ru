...
В языке присутствуют следующие виды символьных постоянных (констант) для целых значений:
...
Также Kotlin поддреживает установленное обозначение для чисел с плавающей запятой:
 
* Тип Double по умолчанию: `123.5`, `123.5e10`
* Тип Floats обозначается с помощью `f` или `F`: `123.5f` 
