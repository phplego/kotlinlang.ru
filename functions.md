...
* Они являются членом другой функции или [выражения](http://kotlinlang.ru/docs/reference/extensions.html)
...
Когда функция возвращает одно-единственное выражение, круглые скобки `{ }` могут быть опущены и тело функции может быть описано после знака `=`
...
О расширениях подробно описано в [отдельной статье](http://kotlinlang.ru/docs/reference/extensions.html)
