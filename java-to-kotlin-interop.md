...
является ошибкой. Однако компилятор имеет возможность генерировать один Java класс фасада, имеющий указанное имя и
содержащий все объявления из всех файлов, которые имеют такое имя. 
...
Самый яркий пример происходит вследствие *стирания типа*:
