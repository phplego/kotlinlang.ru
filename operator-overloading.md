...
(like `+` or `*`) and fixed [precedence](https://kotlinlang.org/docs/reference/grammar.html#precedence). To implement an operator, we provide a [member function](functions.html#member-functions)
