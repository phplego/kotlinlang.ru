...
The unsafe cast in Kotlin is done by the infix operator **as**<!--keyword--> (see [operator precedence](https://kotlinlang.org/docs/reference/grammar.html#operator-precedence)):
